...
\begin{definition}[Pointwise orientation on manifolds]
\end{definition}
...
\begin{definition}[Orientation on manifolds]
\end{definition}
...
\subsubsection{Definitions}
Probably I should use less confusing notations (e.g.\ \(M^-\) instead of \(M\)). Also I am unsure if I need a twofold cover (and a \(\mathbb{Z}\big/2\mathbb{Z}\)-principal bundle) of/over \(X\)..
