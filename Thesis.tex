...
Unsure if I will include this theorem, but certainly not here, rather later.
\begin{theorem}
...
\begin{theorem}[Suspension sequence]
...
Not sure if I am to include a proof of Freudenthal. (Wouldn't hurt I guess)
\begin{theorem}[Freudenthal suspension theorem]
\end{theorem}

\begin{lemma}\cite{thom}
    The natural map
    \[\sus\{MSO(n)\}\to MSO(n+1)\]
